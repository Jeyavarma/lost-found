...
export default function AdminRegister() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-bg to-gray-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="mx-auto w-12 h-12 bg-brand-primary rounded-full flex items-center justify-center mb-4">
            <Shield className="w-6 h-6 text-white" />
          </div>
          <CardTitle className="text-2xl font-bold mcc-text-primary">Admin Registration</CardTitle>
          <CardDescription>Create an administrator account for MCC Lost & Found</CardDescription>
        </CardHeader>
